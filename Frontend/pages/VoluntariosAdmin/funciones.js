document.addEventListener('DOMContentLoaded', () => {
    ...
    const solicitudes = [
        { id: 1, nombre: 'Juan', email: 'juan@example.com', solicitud: 'Quiero ser solo un Donante' },
        { id: 2, nombre: 'Maria', email: 'maria@example.com', solicitud: 'Quiero ser solo un Donante' },
        { id: 3, nombre: 'Carlos', email: 'carlos@example.com', solicitud: 'Quiero ser solo un Donante' }
    ];
